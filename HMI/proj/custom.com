...
//M(Mask1/$85020/"panel_1_1_chs.png"/)
	...
	DEF PITCH_COM=(R/-500,500//$85105,$85105,$85043,/WR2/"panel_1_11_chs.png"/"/NC/_N_NC_GD2_ACX/INI[25]"/360,210,202/460,210,60/);全长螺距补偿
	...
	DEF VAR20=(I//0/$85159,$85159,,/WR4/"panel_1_12_chs.png"/"/NC/_N_NC_GD2_ACX/INI[12]"/360,235,80/405,235,30/);是否有锥度
	DEF VAR21=(I/0,10//$85160,,,$85052/WR4/"panel_1_13_chs.png"/"/NC/_N_NC_GD2_ACX/INI[13]"/0,235,0/460,235,75/);锥度分子
	DEF VAR22=(I/0,800//$85161,,,/WR4/"panel_1_14_chs.png"/"/NC/_N_NC_GD2_ACX/INI[14]"/0,0,0/490,235,30/);锥度分母

	DEF VAR23=(I//0/$85164,$85164,,/WR4//"/NC/_N_NC_GD2_ACX/INI[17]"/360,260,80/405,260,30/);是否有螺旋升角
	DEF VAR24=(I/-45,45//$85055,,,$85042/WR4//"/NC/_N_NC_GD2_ACX/INI[18]"/0,260,0/455,260,75/);度
	DEF VAR25=(I/0,59//$85056,,,$85053/WR4//"/NC/_N_NC_GD2_ACX/INI[19]"/0,260,0/490,260,70/);分
	DEF VAR26=(I/0,59//$85057,,,$85054/WR4//"/NC/_N_NC_GD2_ACX/INI[20]"/0,260,0/520,260,70/);秒
...
;;;;;;;;;;;;;;;;;;;MASK12:修整参数:成型;;;;;;;;;;;;;;;;;;;
//M(Mask12/$85022/"panel_3_4_chs.png"/)
	...
	DEF VAR17=(R/0,1000//$85171,$85171,,$85043/WR2/"panel_3_10_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[36]"/80,310,130/210,310,110/);砂轮最小直径
...
;;;;;;;;;;;;;;;;;;;MASK11:修整参数_滚压轮;;;;;;;;;;;;;;;;;;;
//M(Mask11/$85379/"panel_4_1_chs.png"/)

	DEF VAR11=(R/0,80//$85332,$85332,,$85047/WR2/"panel_4_1_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[19]"/330,70,110/440,70,110/);滚压轮停留时间
	
	DEF VAR1=(R/-500,500//$85331,$85331,,$85043/WR4//"/NC/_N_NC_GD2_ACX/WHEEL[13]"/330,90,110/440,90,110/);NC用初始接触
	DEF VAR2=(R/0,50//$85330,$85330,,$85043/WR2/"panel_4_3_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[2]"/330,110,110/440,110,110/);齿高
	...
	DEF VAR0=(R/0,800//$85329,$85329,,$85043/WR2/"panel_4_2_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[3]"/330,35,110/440,35,110);回零时两轮中间距
...
;;;;;;;;;;;;;;;;;;;MASK17:修整参数_边沿修整;;;;;;;;;;;;;;;;
//M(Mask17/$85702/"panel_17_1_chs.png"/)

	DEF VAR0=(R///$85703,$85703,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[38]"/330,60,110/440,80,110/);砂轮边缘修整初始位置
	DEF VAR1=(R///$85704,$85704,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[39]"/330,80,110/440,100,110/);砂轮边缘修整当前位置

	DEF VAR2=(R///$85705,$85705,,$85043/WR2/"panel_17_1_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[40]"/330,130,110/440,130,110/);砂轮边缘修整接触砂轮左边缘位置
	DEF VAR9=(R///$85712,$85712,,$85043/WR2/"panel_17_8_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[51]"/330,150,110/440,150,110/);砂轮边缘修整接触砂轮右边缘位置
	DEF VAR3=(R/0,30//$85706,$85706,,$85043/WR2/"panel_17_2_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[41]"/330,170,110/440,170,110/);砂轮边缘修整厚度
	DEF VAR4=(R/0,30//$85707,$85707,,$85043/WR2/"panel_17_3_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[42]"/330,190,110/440,190,110/);砂轮边缘修整安全深度值
	DEF VAR10=(R/0,30//$85713,$85713,,$85042/WR2/"panel_17_9_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[52]"/330,210,110/440,210,110/);实际砂轮边缘修整安全深度多走部分角度

	DEF VAR5=(R/0,2//$85708,$85708,,$85043/WR2/"panel_17_4_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[43]"/330,240,110/440,240,110/);砂轮边缘修整进给量
	DEF VAR6=(R/0,2000//$85709,$85709,,$85045/WR2/"panel_17_5_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[44]"/330,260,110/440,260,110/);砂轮边缘修整速度

	DEF VAR7=(R///$85710,$85710,,$85043/WR2/"panel_17_6_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[47]"/330,30,110/440,30,110/);金刚笔对准砂轮回转中心X轴位置
	DEF VAR8=(R/0,1000//$85711,$85711,,$85043/WR2/"panel_17_7_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[50]"/330,50,110/440,50,110/);金刚笔与砂轮中心垂直距离

	DEF QCHECK=(I///$85220,$85219,$85043,/WR4//"/Plc/Q113.5"/0,0,0/0,0,0);循环启动Q点检测	

	HS1=($85379,ac7,se1);"滚压轮"

	VS1=($85702,ac7,se3);"边沿修整"
	VS8=($85386,ac7,se1);"返回"
...
//M(Mask10/$85022/)
	...
	DEF VAR17=(R/0,1000//$85171,$85171,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[36]"/80,310,130/210,310,110/);砂轮最小直径
...
;;;;;;;;;;;;;;;;;;;MASK13:修整返回:成型;;;;;;;;;;;;;;;;;;;
//M(Mask13/$85022/"panel_3_4_chs.png"/)
	...
	DEF VAR12=(R/0,200//$85316,$85316,,$85043/WR4//"/NC/_N_NC_GD2_ACX/DRESSER[23]"/330,230,110/440,230,110/);砂轮宽度
	DEF VAR13=(R/0,1000//$85319,$85319,,$85043/WR1/"panel_3_7_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[24]"/330,250,110/440,250,110/);新砂轮直径
	DEF VAR14=(R/0,1000//$85320,$85320,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[25]"/330,270,110/440,270,110/);砂轮当前直径
	DEF VAR15=(R/0,80//$85317,$85317,,$85046/WR1/"panel_3_8_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL_LINESPEED_DRESS[2]"/330,290,110/440,290,110/);砂轮线速度
	DEF VAR16=(I///$85221,$85221,,$85044/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[37]"/330,310,110/440,310,110/);修整时砂轮转速
