...
//M(Mask18/$85020/"panel_18_4_chs.png"/)
	...
	DEF SCREW_R=(I/*0=$85124,1=$85125//$85103,$85103,,/WR2/"panel_18_4_chs.png"/"/NC/_N_NC_GD2_ACX/INI[1]"/360,35,70/460,35,60/);螺纹旋向
	DEF VAR6=(I/0,50//$85102,$85102,$85051,/WR2/"panel_18_5_chs.png"/"/NC/_N_NC_GD2_ACX/WORK[1]"/360,60,202/460,60,60/);工件头数
	DEF VAR7=(R3/0,50//$85104,$85104,$85043,/WR2/"panel_18_6_chs.png"/"/NC/_N_NC_GD2_ACX/INI[5]"/360,85,202/460,85,60/);工件螺距
	DEF VAR8=(R3/-2000,2000//$85108,$85108,$85043,/WR2/"panel_18_7_chs.png"/"/NC/_N_NC_GD2_ACX/INI[2]"/360,110,202/460,110,60/);工件左端
	DEF VAR9=(R3/-2000,2000//$85109,$85109,$85043,/WR2/"panel_18_8_chs.png"/"/NC/_N_NC_GD2_ACX/INI[3]"/360,135,202/460,135,60/);工件右端
	DEF VAR10=(R/-500,500//$85165,$85165,$85043,/WR2/"panel_18_9_chs.png"/"/NC/_N_NC_GD2_ACX/INI[11]"/360,160,202/460,160,60/);缓冲位置
	...
	DEF VAR20=(I/*0=$85014,1=$85013//$85159,$85159,,/WR2/"panel_18_12_chs.png"/"/NC/_N_NC_GD2_ACX/INI[12]"/360,235,80/405,235,30/);是否有锥度
	DEF VAR21=(I/0,10//$85160,,,$85052/WR2/"panel_18_13_chs.png"/"/NC/_N_NC_GD2_ACX/INI[13]"/0,235,0/460,235,75/);锥度分子
	DEF VAR22=(I/0,800//$85161,,,/WR2/"panel_18_14_chs.png"/"/NC/_N_NC_GD2_ACX/INI[14]"/0,0,0/490,235,30/);锥度分母

	DEF VAR23=(I/*0=$85014,1=$85013/1/$85164,$85164,,/WR1/"panel_18_18_chs.png"/"/NC/_N_NC_GD2_ACX/INI[17]"/360,260,80/405,260,30/);是否有螺旋升角
	DEF VAR24=(I/0,45//$85055,,,$85042/WR2/"panel_18_19_chs.png"/"/NC/_N_NC_GD2_ACX/INI[18]"/0,260,0/460,260,75/);度
	DEF VAR25=(I/0,59//$85056,,,$85053/WR2/"panel_18_20_chs.png"/"/NC/_N_NC_GD2_ACX/INI[19]"/0,260,0/495,260,70/);分
	DEF VAR26=(I/0,59//$85057,,,$85054/WR2/"panel_18_21_chs.png"/"/NC/_N_NC_GD2_ACX/INI[20]"/0,260,0/525,260,70/);秒

	DEF C_INIT=(R/0,360//$85812,$85812,$85042,/WR2/"panel_18_22_chs.png"/"/NC/_N_NC_GD2_ACX/INI[28]"/360,185,202/460,185,60/);头架在程序结束调整到合适角度
	DEF Z_INIT=(R/-500,500//$85813,$85813,$85043,/WR2/"panel_18_23_chs.png"/"/NC/_N_NC_GD2_ACX/INI[29]"/360,210,202/460,210,60/);内螺纹时台面起始位置

	DEF OBJECT_CUMU=(I/0,1000//$85173,$85173,,$85058/WR2/"panel_18_23_chs.png"/"/NC/_N_NC_GD2_ACX/INI[32]"/360,285,110/460,285,110/);工件计件

	DEF VAR27=(I/0,500///WR4//"$MN_USER_DATA_INT[0]"/0,0,0/0,0,0/);润滑间歇时间调用值
	DEF VAR28=(I/0,500///WR4//"$MN_USER_DATA_INT[1]"/0,0,0/0,0,0/);润滑启动时间调用值
	DEF VAR29=(I/0,500//$85127,$85127,$85048,/WR4/"panel_18_15_chs.png"/"/NC/_N_NC_GD2_ACX/INI[22]"/380,320,182/460,320,60/);润滑间歇时间输入值
	DEF VAR30=(I/0,500//$85126,$85126,$85047,/WR4/"panel_18_16_chs.png"/"/NC/_N_NC_GD2_ACX/INI[23]"/380,345,182/460,345,60/);润滑启动时间输入值
...
//M(Mask2/$85021/"panel_2_0_chs.png"/)
	...
	;砂轮选择
	DEF VAR50=(I/*0=$85224,1=$85225//$85203,,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[75]"/0,0,0/132,228,60/);粗磨砂轮选择
	DEF VAR51=(I/*0=$85224,1=$85225//$85204,,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[76]"/0,0,0/222,228,60/);半粗磨砂轮选择
	DEF VAR52=(I/*0=$85224,1=$85225//$85205,,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[77]"/0,0,0/312,228,60/);半精磨砂轮选择
	DEF VAR53=(I/*0=$85224,1=$85225//$85206,,,/WR2//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[78]"/0,0,0/402,228,60/);精磨砂轮选择

	;头架转速显示
	DEF VAR23=(R///,,,/WR1//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[61]"/0,0,0/132,265,60/);粗磨头架转速
	DEF VAR24=(R///,,,/WR1//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[62]"/0,0,0/222,265,60/);半粗磨头架转速
	DEF VAR25=(R///,,,/WR1//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[63]"/0,0,0/312,265,60/);半精磨头架转速
	DEF VAR26=(R///,,,/WR1//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[64]"/0,0,0/402,265,60/);精磨头架转速
	DEF VAR31=(R///,,,/WR4//"/NC/_N_NC_GD2_ACX/INI[5]"/0,0,0/0,0,0/);螺距调用

	;砂轮转速显示
	DEF VAR32=(R///,,,/WR4//"/NC/_N_NC_GD2_ACX/DRESSER[25]"/0,0,0/0,0,0/);当前砂轮直径调用
	DEF VAR33=(I///,,,/WR1//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[71]"/0,0,0/132,286,60/);粗磨砂轮转速
	DEF VAR34=(I///,,,/WR1//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[72]"/0,0,0/222,286,60/);半粗磨砂轮转速
	DEF VAR35=(I///,,,/WR1//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[73]"/0,0,0/312,286,60/);半精磨砂轮转速
	DEF VAR36=(I///,,,/WR1//"/NC/_N_NC_GD2_ACX/TECHNOLOGY[74]"/0,0,0/402,286,60/);精磨砂轮转速

	;界面工艺/DIY选择
	DEF VAR0=(I/*0=$85217,1=$85216/0/$85218,,,/WR4//"/NC/_N_NC_GD2_ACX/PROCESS[1]"/0,0,0/410,25,65);DIY
	;界面设定磨削总量计算
...
//M(Mask3/$85022/"panel_3_4_chs.png"/)
	...
	DEF VAR1=(I/*0=$85344,1=$85345,2=$85346,3=$85347,4=$85348/4/$85387,,,/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[1]"/0,0,0/335,10,60/);修整器
	...
	DEF VAR4=(I/*0=$85327,1=$85328//$85350,,,/WR2/"panel_3_4_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[6]"/0,0,0/435,50,65/);砂轮1状态
	DEF VAR40=(I/*0=$85014,1=$85013//$85806,,,/WR2/"panel_3_13_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[46]"/0,0,0/505,50,30/);砂轮1是否修整
	DEF VAR5=(I/0,1000//$85340,$85340,,/WR2/"panel_3_5_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[26]"/325,70,110/440,70,60/);粗修次数
	DEF VAR6=(R/0,0.5//$85308,$85308,,$85043/WR2/"panel_3_5_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[28]"/325,90,110/440,90,110/);粗修量
	DEF VAR7=(R/0,1000//$85306,$85306,,$85045/WR2/"panel_3_5_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[30]"/325,110,110/440,110,110/);粗修速度
	DEF VAR13=(R/0,1000//$85319,$85319,,$85043/WR2/"panel_3_7_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[24]"/325,130,110/440,130,110/);新砂轮1直径
	DEF VAR14=(R/0,1000//$85320,$85320,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[25]"/325,150,115/440,150,110/);砂轮1当前直径
	DEF VAR16=(I///$85221,$85221,,$85044/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[37]"/325,170,110/440,170,110/);修整时砂轮1转速

	DEF VAR23=(I/*0=$85800,1=$85801//$85350,,,/WR2/"panel_3_4_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[41]"/0,0,0/435,220,65/);砂轮2状态
	DEF VAR41=(I/*0=$85014,1=$85013//$85807,,,/WR2/"panel_3_13_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[47]"/0,0,0/505,220,30/);砂轮2是否修整
	DEF VAR8=(I/0,1000//$85341,$85341,,/WR2/"panel_3_6_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[27]"/325,240,110/440,240,60/);精修次数
	DEF VAR9=(R/0,0.5//$85309,$85309,,$85043/WR2/"panel_3_6_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[29]"/325,260,110/440,260,110/);精修量
	DEF VAR10=(R/0,1000//$85307,$85307,,$85045/WR2/"panel_3_6_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[31]"/325,280,110/440,280,110/);精修速度
	DEF VAR24=(R/0,1000//$85802,$85802,,$85043/WR2/"panel_3_7_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[38]"/325,300,110/440,300,110/);新砂轮2直径
	DEF VAR25=(R/0,1000//$85803,$85803,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[39]"/325,320,115/440,320,110/);砂轮2当前直径
	DEF VAR27=(I///$85805,$85805,,$85044/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[44]"/325,340,110/440,340,110/);修整时砂轮2转速

	DEF VAR12=(R/0,200//$85316,$85316,,$85043/WR2/"panel_3_9_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[23]"/330,230,110/440,230,110/);砂轮宽度

	DEF VAR15=(R/0,80//$85317,$85317,,$85046/WR2/"panel_3_8_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL_LINESPEED_DRESS[2]"/80,280,110/210,280,110/);砂轮线速度
	DEF VAR26=(R/0,1000//$85804,$85804,,$85043/WR2/"panel_3_10_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[40]"/80,300,130/210,300,110/);砂轮1&2中心距
	DEF WHEEL1_MIN=(R/0,100//$85810,$85810,,$85043/WR2/"panel_3_11_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[36]"/80,320,130/210,320,110/);砂轮1最小直径
	DEF WHEEL2_MIN=(R////WR4//"/NC/_N_NC_GD2_ACX/DRESSER[45]"/0,0,0/0,0,0/);砂轮2最小直径
	DEF WHEEL_MAX=(R/0,100//$85811,$85811,,$85043/WR2/"panel_3_12_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[50]"/80,340,130/210,340,110/);砂轮最大磨削直径
	...
	DEF VAR33=(R////WR4//"/NC/_N_NC_GD2_ACX/WHEEL[15]"/0,0,0/0,0,0/);砂轮1初始接触位置
	DEF VAR34=(R////WR4//"/NC/_N_NC_GD2_ACX/WHEEL[1]"/0,0,0/0,0,0/);修整轮直径
	DEF VAR35=(R////WR4//"/NC/_N_NC_GD2_ACX/WHEEL[23]"/0,0,0/0,0,0/);砂轮2NC用初始接触
	DEF VAR36=(R////WR4//"/NC/_N_NC_GD2_ACX/WHEEL[25]"/0,0,0/0,0,0/);砂轮2初始接触位置
	...
	CHANGE(VAR15)
		VAR16.VAL=VAR15.VAL*60000/(PI*VAR14.VAL);修整时砂轮1转速计算
		VAR27.VAL=VAR15.VAL*60000/(PI*VAR25.VAL);修整时砂轮2转速计算
	END_CHANGE

	CHANGE(VAR25)
		VAR22.VAL=(VAR24.VAL-VAR25.VAL)/2;累计修整量计算
		VAR27.VAL=VAR15.VAL*60000/(PI*VAR25.VAL);修整时砂轮转速计算
	END_CHANGE
	...
	SUB(UP5)
		IF VAR1.VAL==4;成型X
			...
			ELSE
				...
				VAR36.VAL=VAR33.VAL+(VAR26.VAL-VAR13.VAL/2-VAR24.VAL/2-VAR34.VAL);砂轮2初始接触位
				VAR31.VAL=VAR33.VAL-VAR32.VAL;砂轮1NC用初始接触
				VAR35.VAL=VAR36.VAL+VAR32.VAL;砂轮2NC用初始接触
			ENDIF
		ENDIF
	END_SUB
...
//M(Mask17/$85379/"panel_17_1_chs.png"/)
	...
	DEF VAR0=(R/0,800//$85329,$85329,,$85043/WR2/"panel_17_2_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[3]"/325,10,110/440,10,110);回零时砂轮1与修整轮中间距

	DEF VAR16=(R/-500,500//$85336,$85336,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[42]"/325,40,110/440,40,110/);修整轮相对砂轮1&2修整起点位置X坐标

	DEF VAR12=(R/-800,800//$85342,$85342,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[22]"/325,70,110/440,70,110/);砂轮1&2与修整轮Z中心
	DEF VAR20=(R/-800,800//$85808,$85808,,$85043/WR2/"panel_17_7_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[48]"/325,90,115/440,90,110/);砂轮开到修整断面位置
	DEF VAR21=(R/-800,800//$85809,$85809,,$85043/WR2/"panel_17_8_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[49]"/325,110,115/440,110,110/);修整轮到修整端面距离

	DEF VAR11=(R/0,80//$85332,$85332,,$85047/WR2/"panel_17_1_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[19]"/325,140,130/440,140,110/);滚压轮停留时间1
	DEF VAR22=(R/0,80//$85339,$85339,,$85047/WR2/"panel_17_1_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[26]"/325,160,130/440,160,110/);滚压轮停留时间2

	DEF VAR2=(R/0,50//$85330,$85330,,$85043/WR2/"panel_17_3_chs.png"/"/NC/_N_NC_GD2_ACX/DRESSER[2]"/325,190,110/440,190,110/);齿高
	DEF VAR7=(R/0,500//$85396,$85396,,$85043/WR2/"panel_17_5_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[1]"/325,210,110/440,210,110/);修整轮直径
	DEF VAR8=(R/0,60//$85397,$85397,,$85046/WR2/"panel_17_6_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[2]"/325,230,110/440,230,110/);修整轮线速度
	DEF VAR9=(I///$85325,$85325,,$85044/WR1//"/NC/_N_NC_GD2_ACX/WHEEL[20]"/325,250,110/440,250,110/);修整轮转速

	DEF VAR1=(R/-500,500//$85331,$85331,,$85043/WR1//"/NC/_N_NC_GD2_ACX/WHEEL[13]"/60,280,130/190,280,110/);砂轮1NC用初始接触
	DEF VAR3=(R/-500,500//$85398,$85398,,$85043/WR1//"/NC/_N_NC_GD2_ACX/WHEEL[15]"/60,300,110/190,300,110/);砂轮1初始接触位置
	DEF VAR5=(R/-500,500//$85399,$85399,,$85043/WR1/"panel_17_4_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[11]"/60,320,110/190,320,110/);砂轮1当前接触位置

	DEF VAR13=(R/-500,500//$85333,$85333,,$85043/WR1//"/NC/_N_NC_GD2_ACX/WHEEL[23]"/310,280,130/440,280,110/);砂轮2NC用初始接触
	DEF VAR14=(R/-500,500//$85334,$85334,,$85043/WR1//"/NC/_N_NC_GD2_ACX/WHEEL[25]"/310,300,110/440,300,110/);砂轮2初始接触位置
	DEF VAR15=(R/-500,500//$85335,$85335,,$85043/WR1/"panel_17_4_chs.png"/"/NC/_N_NC_GD2_ACX/WHEEL[21]"/310,320,110/440,320,110/);砂轮2当前接触位置
...
//M(Mask9/$85385/"panel_9_1_chs.png"/)
	...
	DEF VAR1=(R/0,200//$85431,$85431,,$85043/WR2/"panel_9_2_chs.png"/"/NC/_N_NC_GD2_ACX/DARC[3]"/330,50,110/440,50,110/);公称直径

	DEF VAR2=(R/0,50//$85440,$85440,,$85043/WR2/"panel_9_3_chs.png"/"/NC/_N_NC_GD2_ACX/DARC[12]"/330,80,110/440,80,110/);过渡圆弧半径

	DEF VAR3=(R/0,90//$85433,$85433,,$85042/WR2/"panel_9_4_chs.png"/"/NC/_N_NC_GD2_ACX/DARC[5]"/330,110,110/440,110,110/);接触角
	DEF VAR4=(R/0,50//$85432,$85432,,$85043/WR2/"panel_9_5_chs.png"/"/NC/_N_NC_GD2_ACX/DARC[4]"/330,130,110/440,130,110/);钢球直径
	DEF VAR5=(R/0,50//$85434,$85434,,$85043/WR2/"panel_9_6_chs.png"/"/NC/_N_NC_GD2_ACX/DARC[6]"/330,150,110/440,150,110/);初始左滚道
	DEF VAR6=(R/0,50//$85435,$85435,,$85043/WR2/"panel_9_7_chs.png"/"/NC/_N_NC_GD2_ACX/DARC[7]"/330,170,110/440,170,110/);初始右滚道

	DEF VAR7=(R/-10,50//$85436,$85436,,$85043/WR2/"panel_9_8_chs.png"/"/NC/_N_NC_GD2_ACX/DARC[8]"/330,200,110/440,200,110/);调整左滚道
	DEF VAR8=(R/-10,50//$85437,$85437,,$85043/WR2/"panel_9_9_chs.png"/"/NC/_N_NC_GD2_ACX/DARC[9]"/330,220,110/440,220,110/);调整右滚道
	DEF VAR9=(R/0,50//$85438,$85438,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DARC[10]"/330,240,110/440,240,110/);当前左滚道
	DEF VAR10=(R/0,50//$85439,$85439,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DARC[11]"/330,260,110/440,260,110/);当前右滚道
	DEF VAR11=(R///$85441,$85441,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DARC[13]"/95,290,115/210,290,110/);左滚道水平偏心
	DEF VAR12=(R///$85442,$85442,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DARC[14]"/95,310,115/210,310,110/);右滚道水平偏心
	DEF VAR13=(R///$85443,$85443,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DARC[15]"/325,290,115/440,290,110/);左滚道垂直偏心
	DEF VAR14=(R///$85444,$85444,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DARC[16]"/325,310,115/440,310,110/);右滚道垂直偏心
...
//M(Mask10/$85022/"panel_3_4_chs.png"/)
	...
	DEF VAR4=(I/*0=$85327,1=$85328//$85350,,,/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[6]"/0,0,0/435,50,65/);砂轮1状态
	DEF VAR40=(I/*0=$85014,1=$85013//$85806,,,/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[46]"/0,0,0/505,50,30/);砂轮1是否修整
	DEF VAR5=(I/0,1000//$85340,$85340,,/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[26]"/325,70,110/440,70,60/);粗修次数
	DEF VAR6=(R/0,0.5//$85308,$85308,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[28]"/325,90,110/440,90,110/);粗修量
	DEF VAR7=(R/0,1000//$85306,$85306,,$85045/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[30]"/325,110,110/440,110,110/);粗修速度
	DEF VAR13=(R/0,1000//$85319,$85319,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[24]"/325,130,110/440,130,110/);新砂轮1直径
	DEF VAR14=(R/0,1000//$85320,$85320,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[25]"/325,150,115/440,150,110/);砂轮1当前直径
	DEF VAR16=(I///$85221,$85221,,$85044/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[37]"/325,170,110/440,170,110/);修整时砂轮1转速

	DEF VAR23=(I/*0=$85800,1=$85801//$85350,,,/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[41]"/0,0,0/435,220,65/);砂轮2状态
	DEF VAR41=(I/*0=$85014,1=$85013//$85807,,,/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[47]"/0,0,0/505,220,30/);砂轮2是否修整
	DEF VAR8=(I/0,1000//$85341,$85341,,/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[27]"/325,240,110/440,240,60/);精修次数
	DEF VAR9=(R/0,0.5//$85309,$85309,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[29]"/325,260,110/440,260,110/);精修量
	DEF VAR10=(R/0,1000//$85307,$85307,,$85045/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[31]"/325,280,110/440,280,110/);精修速度
	DEF VAR24=(R/0,1000//$85802,$85802,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[38]"/325,300,110/440,300,110/);新砂轮2直径
	DEF VAR25=(R/0,1000//$85803,$85803,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[39]"/325,320,115/440,320,110/);砂轮2当前直径
	DEF VAR27=(I///$85805,$85805,,$85044/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[44]"/325,340,110/440,340,110/);修整时砂轮2转速

	DEF VAR12=(R/0,200//$85316,$85316,,$85043/WR2//"/NC/_N_NC_GD2_ACX/DRESSER[23]"/330,230,110/440,230,110/);砂轮宽度

	DEF VAR15=(R/0,80//$85317,$85317,,$85046/WR1//"/NC/_N_NC_GD2_ACX/WHEEL_LINESPEED_DRESS[2]"/80,280,110/210,280,110/);砂轮线速度
	DEF VAR26=(R/0,1000//$85804,$85804,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[40]"/80,300,130/210,300,110/);砂轮1&2中心距
	DEF WHEEL1_MIN=(R/0,100//$85810,$85810,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[36]"/80,320,130/210,320,110/);砂轮1最小直径
	DEF WHEEL2_MIN=(R////WR4//"/NC/_N_NC_GD2_ACX/DRESSER[45]"/0,0,0/0,0,0/);砂轮2最小直径
	DEF WHEEL_MAX=(R/0,100//$85811,$85811,,$85043/WR1//"/NC/_N_NC_GD2_ACX/DRESSER[50]"/80,340,130/210,340,110/);砂轮最大磨削直径
