...
//M(Mask1/$85020/"panel_1_1_chs.png"/)
	...
	DEF VAR11=(I/*0=$85146,1=$85147,2=$85148//$85145,,,/WR4/"panel_1_3_chs.png"/"/NC/_N_NC_GD2_ACX/TOOL_SET[20]"/0,0,0/270,30,70/);选择对刀位置
	...
	DEF WHELL_POS_INI=(R///$85169,$85169,$85043,/WR2/"panel_1_24_chs.png"/"/NC/_N_NC_GD2_ACX/PROCESS[14]"/10,350,210/120,350,60/);初始磨削接触位(对刀完成后磨削接触位)

	DEF C_POS_USED=(R/0,360//$85173,$85173,$85042,/WR1//"/NC/_N_NC_GD2_ACX/TOOL_SET[5]"/210,330,180/290,330,60/);C轴起始角度
	DEF C_POS_INPUT=(R/0,360//$85174,$85174,$85042,/WR2/"panel_1_25_chs.png"/"/NC/_N_NC_GD2_ACX/TOOL_SET[41]"/210,350,180/290,350,60/);手动输入的C起始角
...
//M(Mask18/$85020/"panel_18_4_chs.png"/)
	...
	DEF VAR17=(R///$85157,$85157,$85043,/WR1//"$AC_DRF[Z]"/10,310,210/120,310,60/);DRF_Z
	DEF VAR19=(R///$85158,$85158,$85043,/WR1//"/NC/_N_NC_GD2_ACX/PROCESS[5]"/10,330,210/120,330,60/);当前磨削接触位
	DEF WHELL_POS_INI=(R///$85169,$85169,$85043,/WR2//"/NC/_N_NC_GD2_ACX/PROCESS[14]"/10,350,210/120,350,60/);初始磨削接触位(对刀完成后磨削接触位)

	DEF C_POS_USED=(R/0,360//$85173,$85173,$85042,/WR1//"/NC/_N_NC_GD2_ACX/TOOL_SET[5]"/210,330,180/290,330,60/);C轴起始角度
	DEF C_POS_INPUT=(R/0,360//$85174,$85174,$85042,/WR2//"/NC/_N_NC_GD2_ACX/TOOL_SET[41]"/210,350,180/290,350,60/);手动输入的C起始角
...
;;;;;;;;;;;;;;;;;;;MASK21:自动对刀;;;;;;;;;;;;;;;;;;;;;;;;
//M(Mask21/$85026//)
	DEF VAR0=(I/*0=$85500,1=$85501//$85502,,,/WR2//"/NC/_N_NC_GD2_ACX/TOOL_SET[32]"/0,0,0/440,20,60);测头类型(0测头/1开关),界面调试用
	;DEF VAR0=(I/*0=$85500,1=$85501/0/$85502,,,/WR1//"/NC/_N_NC_GD2_ACX/TOOL_SET[32]"/0,0,0/440,20,60);测头类型(测头),生成文件用
	...
	DEF VAR2=(R/-2000,2000//$85503,$85503,,$85043/WR4//"/NC/_N_NC_GD2_ACX/INI[49]"/330,70,110/440,70,110/);内螺纹自动对刀测头Z轴方向起始位置
	DEF VAR24=(R/-2000,2000//$85528,$85528,,$85043/WR4//"/NC/_N_NC_GD2_ACX/INI[43]"/320,70,150/440,70,110/);砂轮中心与测头中心重合Z坐标，外螺纹自动对刀用
	DEF VAR3=(R/0,359//$85504,$85504,,$85042/WR4//"/NC/_N_NC_GD2_ACX/INI[50]"/330,90,110/440,90,110/);内螺纹测头自动对刀工件C方向合适角度
	DEF VAR4=(R/0,500//$85505,$85505,,$85043/WR4//"/NC/_N_NC_GD2_ACX/TOOL_SET[24]"/330,110,110/440,110,110/);内螺纹测头球中心/接近开关探测面与磨杆距离(X向)
	DEF VAR23=(R/-500,500//$85527,$85527,,$85043/WR4//"/NC/_N_NC_GD2_ACX/TOOL_SET[11]"/330,130,110/440,130,110/);内螺纹测头/开关与砂轮距离(Z向)
	...
	DEF VAR7=(R/-2000,2000//$85513,$85513,,$85043/WR4//"/NC/_N_NC_GD2_ACX/INI[53]"/330,170,110/440,170,110/);内螺纹自动对刀开关测量方式下，开关进入工件开始测量Z起始位置
